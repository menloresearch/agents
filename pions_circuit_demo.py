#!/usr/bin/env python3
"""
Pions Circuit Demo Script

This script demonstrates how to use the pions circuit components to create
and visualize agent workflows in series and parallel configurations.
Pions is a standalone library that uses bhumi for LLM operations.
"""
...
# Import the pions library components
import pions
from pions import Agent, BaseTool, CircuitBuilder, CircuitVisualizer

# Import example agents and tools from pions.examples
try:
    from pions.examples import ResearchAgent, ContentAnalysisAgent, SimpleSearchTool, SummarizationTool
...
async def main():
    """Run the pions circuit demo."""
    print("===== Pions Circuit Demo =====")
    print("Demonstrating pions as a standalone library using bhumi for LLM operations")
    print(f"Pions version: {pions.__version__}")
    
    await visualize_circuits()
    
    print("\n===== Demo Complete =====")
    print("For more information, visit: https://github.com/janhq/asimov")
